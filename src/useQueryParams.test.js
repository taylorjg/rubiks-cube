...
describe('useQueryParams', () => {
  ...
  describe('getBool', () => {
    ...
    it('when param is present and true', () => {
    ...
    it('when param is present and false', () => {
  ...
  describe('getBools', () => {
    ...
    it('when params are present', () => {
      const { result } = renderHook(() => useQueryParams('?flag=1&flag=0&flag=yes&flag=no'))
      const queryParams = result.current
